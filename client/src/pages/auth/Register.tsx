      ...
      <div className="min-h-[calc(100vh-56px)] flex items-center justify-center px-4 py-8 bg-gradient-to-b from-[#e8f4fd] to-[#f0f2f5]">
        <div className="w-full max-w-[440px]">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-1 text-sm">{t('auth.verifyOTP')}</p>
          </div>
    ...
    <div className="min-h-[calc(100vh-56px)] flex items-center justify-center px-4 py-8 bg-gradient-to-b from-[#e8f4fd] to-[#f0f2f5]">
      <div className="w-full max-w-[440px]">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500 mt-1 text-sm">{t('auth.signUp')}</p>
        </div>
          ...
          <form onSubmit={handleSendOTP} className="space-y-3.5">
            ...
            <div>
              ...
              <input
                ...
                className={`input-field ${fieldErrors.fullName ? 'border-red-400' : ''}`}
              />
            ...
            <div>
              ...
              <input
                ...
                placeholder="LionKing"
                className={`input-field ${fieldErrors.nickname ? 'border-red-400' : ''}`}
              />
            ...
            <div>
              ...
              <div className="flex gap-2">
                <select
                  ...
                  className="bg-white border border-gray-300 rounded-lg px-3 py-3 text-gray-800 focus:border-[#00A8FF] focus:outline-none text-sm"
                >
                  {countries.map((c) => (
                ...
                <input
                  ...
                  maxLength={9}
                  className={`input-field flex-1 ${fieldErrors.phoneNumber ? 'border-red-400' : ''}`}
                />
              </div>
            ...
            <div className="flex items-start gap-2 pt-1">
              <div className="relative">
                ...
                <label
                  htmlFor="terms"
                  className={`w-4 h-4 rounded border flex items-center justify-center cursor-pointer mt-0.5 transition-colors ${
                    formData.agreeTerms
              ...
              <label htmlFor="terms" className="text-xs text-gray-500 cursor-pointer select-none">
                {t('auth.agreeTerms')}{' '}
                <a href="#" className="text-[#00A8FF] hover:underline">{t('auth.terms')}</a>
                {' & '}
                <a href="#" className="text-[#00A8FF] hover:underline">{t('auth.privacy')}</a>
              </label>
            </div>
            ...
            <p className="text-center text-gray-500 text-sm pt-2">
              {t('auth.hasAccount')}{' '}
              <Link to="/login" className="text-[#00A8FF] hover:underline font-medium">
                {t('auth.signInLink')}
              </Link>
            </p>
          </form>
